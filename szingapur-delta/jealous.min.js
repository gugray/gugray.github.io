...
var proxyJsonp="https://script.google.com/macros/s/AKfycbwmqG55tt2d2FcT_WQ3WjCSKmtyFpkOcdprSITn45-4UgVJnzp9/exec";jQuery.ajaxOrig=jQuery.ajax,jQuery.ajax=function(r,e){function t(r){return r=encodeURI(r).replace(/&/g,"%26"),proxyJsonp+"?url="+r+"&callback=?"}(s="object"==typeof r?r:e||{}).url=s.url||("string"==typeof r?r:"");var o,a,c,s=jQuery.ajaxSetup({},s),p=(o=s.url,a=s,(c=document.createElement("a")).href=o,a.crossOrigin&&"http"==o.substr(0,4).toLowerCase()&&"localhost"!=c.hostname&&"127.0.0.1"!=c.hostname&&c.hostname!=window.location.hostname);return s.proxy&&0<s.proxy.length&&(proxyJsonp=s.proxy,"object"==typeof r?r.crossDomain=!0:"object"==typeof e&&(e.crossDomain=!0)),p&&("object"==typeof r?r.url&&(r.url=t(r.url),r.charset&&(r.url+="&charset="+r.charset),r.dataType="json"):"string"==typeof r&&"object"==typeof e&&(r=t(r),e.charset&&(r+="&charset="+e.charset),e.dataType="json")),jQuery.ajaxOrig.apply(this,arguments)},jQuery.ajax.prototype=new jQuery.ajaxOrig,jQuery.ajax.prototype.constructor=jQuery.ajax;
...
var JM=JM||{};JM.catJargon=function(){"use strict";function e(){var e=$(window).scrollTop();3*$(".header-wrap").height()<e?function(){if($(".toTop").hasClass("visible"))return;var e=$(".content").offset().left+$(".content").width(),s=$("body").width();$(".toTop").css("right",s-e),$(".toTop").addClass("visible")}():$(".toTop").removeClass("visible")}function i(e){if(e.startsWith("ap"));for(var s=function(e){for(var s=e.split(/[\s\-&]+/),t=[],a=0;a!=s.length;++a){var i=s[a].replace(/[.,\/#!$%\^&\*;:{}=\-_`~()]/g,"");""!=i&&t.push(i)}return t}(e),t="",a=0;a!=s.length;++a)0<a&&(t+=" "),t+=s[a];return t}$(document).ready(function(){0!=$("#catjargon").length&&("onhashchange"in window&&(window.onhashchange=function(){var e=window.location.hash.substr(1),s=$("a[name='"+e+"']").closest(".entry");s.addClass("flash"),setTimeout(function(){s.removeClass("flash")},500)}),$(window).scroll(e),e(),$(".toTop").click(function(){document.location.hash=""}),$("#txtSearch").val(""),$("#txtSearch").bind("input",function(){$(".disclaimer").removeClass("visible"),$("#toggleDisclaimer").removeClass("selected"),$(".glossary-toc").removeClass("visible"),$("#toggleTOC").removeClass("selected"),function(){var a=i($("#txtSearch").val().toLowerCase());$(".entry").each(function(){for(var e=$(this).find("h2 a").text().toLowerCase().split(";"),s=!1,t=0;t!=e.length&&!s;++t){i(e[t]).startsWith(a)&&(s=!0)}$(this).find("p.cref a").each(function(){i($(this).text().toLowerCase()).startsWith(a)&&(s=!0)}),s?$(this).removeClass("hidden"):$(this).addClass("hidden")})}()}),""==window.location.hash&&setTimeout(function(){$("#txtSearch").focus()},50),$("#toggleDisclaimer").click(function(e){$(".disclaimer").hasClass("visible")?($(".disclaimer").removeClass("visible"),$("#toggleDisclaimer").removeClass("selected")):($(".disclaimer").addClass("visible"),$(this).addClass("selected"),$(".glossary-toc").removeClass("visible"),$("#toggleTOC").removeClass("selected")),e.preventDefault()}),$("#toggleTOC").click(function(e){$(".glossary-toc").hasClass("visible")?($(".glossary-toc").removeClass("visible"),$("#toggleTOC").removeClass("selected")):($(".disclaimer").removeClass("visible"),$("#toggleDisclaimer").removeClass("selected"),$(".glossary-toc").addClass("visible"),$(this).addClass("selected")),e.preventDefault()}),function(){var t="";$(".entry h2 a").each(function(){var e=$(this).text(),s=$(this).attr("name");""!=t&&(t+="&nbsp;&bull; "),t+="<a href='#"+s+"'>"+function(e){return e.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}(e)+"</a>"}),$(".glossary-toc").html(t)}())})}();
var JM=JM||{};JM.site=function(){"use strict";$(document).ready(function(){$(".catSelector span").click(function(e){e.stopPropagation(),$(this).hasClass("primary")?($(".catSelector span").removeClass("selected"),$(this).addClass("selected")):$(".catSelector span.primary").hasClass("selected")?($(".catSelector span.primary").removeClass("selected"),$(this).addClass("selected")):$(this).hasClass("selected")?1<$(".catSelector span.selected").length&&$(this).removeClass("selected"):$(this).addClass("selected"),function(){if($(".catSelector span.primary").hasClass("selected"))return $(".toc-item").removeClass("hidden");var c={};$(".catSelector span.selected").each(function(){c[$(this).text()]=!0}),$(".toc-item").each(function(){var e=[];$(this).find(".filedunder span").each(function(){e.push($(this).text())});for(var s=!1,t=0;t!=e.length;++t){var a=e[t];if(c.hasOwnProperty(a)){s=!0;break}}s?$(this).removeClass("hidden"):$(this).addClass("hidden")})}()})})}();
var JM=JM||{};JM.locaQuiz=function(){"use strict";var l="",c=0;$(document).ready(function(){if(0!=$("#localizationQuiz").length){var a=localStorage.getItem("locaQuizCount");a||(a=1,localStorage.setItem("locaQuizCount",a)),$(".start").click(function(){$(".start").addClass("hidden"),$(".qpage[data-qix='1']").addClass("active"),$("p.lede").css("display","none"),ga("send",{hitType:"event",eventCategory:"locaquiz",eventAction:"locaquiz-start",eventValue:a}),++a,localStorage.setItem("locaQuizCount",a)}),$(".option").click(function(){var a=$(this).closest(".qpage");a.hasClass("solved")||(a.addClass("solved"),$(this).hasClass("correct")?a.addClass("correct"):a.addClass("false"),$(this).addClass("chosen"))}),$(".continue").click(function(){var a=$(this).closest(".qpage");a.removeClass("active");var e=a.find(".option.chosen"),t=e.data("ox"),s="N";e.hasClass("correct")&&(++c,s="Y");var o=a.data("qix")+1;if(2<o&&(l+="!"),l+=s+"-"+t,o<=10)$(".qpage[data-qix='"+o+"']").addClass("active");else{$("#localizationQuiz .result").addClass("visible");var i="You are<br /> AWESOME";c<3?i="GREAT!<br/>But you're not from this industry,<br/>are you?":c<7&&(i="Not too shabby<br/>AT ALL!"),$(".result .awesome").html(i),$("#locaQuizScore").text(c),ga("send",{hitType:"event",eventCategory:"locaquiz",eventAction:"locaquiz-finish",eventLabel:l,eventValue:c})}})}})}();
var JM=JM||{};JM.lspKeywords=function(){"use strict";var n=["#f9bd4e","#50cea8","#a6d5e8","#c493ff","#e1708c","#3eabb4"],t={},a=0,l=0;function e(){if($(".lspWalkStep").removeClass("visible"),6!=l)if($(".lspWalkStep.step"+l).addClass("visible"),$(".lspKeyWalker").addClass("visible"),0==l?($(".walkCommands .next").text("Next"),$(".walkCommands .close").text("Close")):5==l&&($(".walkCommands .next").text("Finish"),$(".walkCommands .close").text("")),$("#lspKeyViz").hasClass("large"))0==l?($(".lspKeyWalker").css("top","10rem"),$(".lspKeyWalker").css("left","4rem"),$(".lspKeyWalker").css("right","")):1==l?($(".lspKeyWalker").css("top","2.5rem"),$(".lspKeyWalker").css("left","2rem")):2==l?($(".lspKeyWalker").css("top","6rem"),$(".lspKeyWalker").css("left",""),$(".lspKeyWalker").css("right","2rem")):5==l&&($(".lspKeyWalker").css("top","2.5rem"),$(".lspKeyWalker").css("left","17rem"),$(".lspKeyWalker").css("right",""));else{var e=null;if(0==l){var s=$("#lspKeyChart").position().top+120;$(".lspKeyWalker").css("top",s),$(".lspKeyWalker").css("left",""),$(".lspKeyWalker").css("right",""),(e=$(".lspKeyWalker").offset()).top-=140}else if(1==l){s=$("#lspKeyChart").position().top+5;$(".lspKeyWalker").css("top",s),$(".lspKeyWalker").css("left","100px")}else if(2==l){s=$("#lspKeyLegend").position().top;$(".lspKeyWalker").css("top",s+100),$(".lspKeyWalker").css("left","50px"),(e=$(".lspKeyWalker").offset()).top-=140}else if(5==l){s=$("#lspKeyChart").position().top+5;$(".lspKeyWalker").css("top",s),$(".lspKeyWalker").css("left",""),$(".lspKeyWalker").css("right","20px"),(e=$(".lspKeyWalker").offset()).top-=140}e&&$("html, body").animate({scrollTop:e.top-100,scrollLeft:e.left})}else $(".lspKeyWalker").removeClass("visible")}function o(e){return e.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function s(e){!function(e){for(var s="",l=0;l!=e.length;++l){var t=e[l];s+="<div class='cluster"+l+" cluster'>",s+="<span class='label'>",s+="Cluster "+"ABCDEF"[l]+": "+t.sites.length,s+="</span> ",s+="<b>"+o(t.words)+"</b>",s+="<br/><i>";for(var a=0;a!=t.data.length;++a){var r=t.data[a];0!=a&&(s+=", "),s+="<u>"+(r.rank+1)+"</u>&nbsp;",s+=o(r.url)}s+="</i>",s+="</div>"}$("#lspKeyLegend").html(s)}(e);var s={datasets:function(e){for(var s=[],l=0;l!=e.length;++l){for(var t={data:[],backgroundColor:n[l],hoverBackgroundColor:n[l]},a=e[l].data,r=0;r!=a.length;++r){var o=a[r];t.data.push({x:o.x,y:o.y,r:20-Math.round(o.rank/3),tooltip:o.url})}s.push(t)}return s}(e)},l=document.getElementById("lsp-keychart-canvas").getContext("2d");window.lspKeyChart=new Chart(l,{type:"bubble",data:s,options:{responsive:!0,maintainAspectRatio:!1,scales:{xAxes:[{display:!1}],yAxes:[{display:!1}]},legend:{display:!1},tooltips:{callbacks:{label:function(e,s){return s.datasets[e.datasetIndex].data[e.index].tooltip}}},hover:{onHover:function(e){e&&e.length&&0!=e.length?function(e,s){$(".cluster"+e+" u:nth-child("+(s+1)+")").addClass("hilite")}(e[0]._datasetIndex,e[0]._index):$(".cluster u").removeClass("hilite")}}}})}function r(){var e;e="stemmed"==$("#stem").text()?"stem-":"nostem-",$("#clust2").hasClass("selected")?e+="2":$("#clust3").hasClass("selected")?e+="3":$("#clust4").hasClass("selected")?e+="4":$("#clust5").hasClass("selected")?e+="5":e+="6",$("#lspKeyChart canvas").remove(),$("#lspKeyChart").html("<canvas id='lsp-keychart-canvas'></canvas>"),s(t[e])}function i(){r(),$(".ctrl-left").click(function(e){$(".ctrl-left").removeClass("selected"),$(this).addClass("selected"),r(),e.preventDefault()}),$(".ctrl-right").click(function(e){"stemmed"==$(this).text()?$(this).text("surface"):$(this).text("stemmed"),r(),e.preventDefault()})}function c(e,s){var l=new XMLHttpRequest;l.open("GET",e,!0),l.onreadystatechange=function(){4===this.readyState&&200===this.status&&(t[s]=JSON.parse(l.responseText),0==--a&&i())},l.send()}$(document).ready(function(){0!=$("#lspKeyViz").length&&(a=11,c("/files/lsp-keywords/data-stem-6.json","stem-6"),c("/files/lsp-keywords/data-stem-5.json","stem-5"),c("/files/lsp-keywords/data-stem-4.json","stem-4"),c("/files/lsp-keywords/data-stem-3.json","stem-3"),c("/files/lsp-keywords/data-stem-2.json","stem-2"),c("/files/lsp-keywords/data-nostem-6.json","nostem-6"),c("/files/lsp-keywords/data-nostem-5.json","nostem-5"),c("/files/lsp-keywords/data-nostem-4.json","nostem-4"),c("/files/lsp-keywords/data-nostem-3.json","nostem-3"),c("/files/lsp-keywords/data-nostem-2.json","nostem-2"),$.ajax({type:"GET",url:"/static/lib/chart-2.1.6.min.js",success:function(){0==--a&&i()},dataType:"script",cache:!1}),$(".ctrl-minimize").click(function(){$("#lspKeyViz").removeClass("large"),$("body").css("overflow-y","scroll"),$("#lspKeyChart canvas").css("height","17rem"),$(".lspKeyWalker").removeClass("visible")}),$(".enlarge").click(function(){$("#lspKeyViz").addClass("large"),$("body").css("overflow-y","hidden"),$("#lspKeyChart canvas").css("height","100% !important"),$(".lspKeyWalker").removeClass("visible")}),$(".walkthrough").click(function(){$(".lspKeyWalker").hasClass("visible")?$(".lspKeyWalker").removeClass("visible"):(l=0,e())}),$(".walkCommands .next").click(function(){++l,e()}),$(".walkCommands .close").click(function(){$(".lspKeyWalker").removeClass("visible")}))})}();
var JM=JM||{};JM.nmt=function(){"use strict";function s(e){$(".nmtBlock .xl").addClass("meta"),$("#xlStraight").text(e||"Regular translation"),$("#xlCrazy").text(e||"Translation from garbled model")}$(document).ready(function(){$(".nmtHeader .button").click(function(){if(!$(this).hasClass("disabled")){new Date;var e=$.ajax({url:"https://mtserv.kginno.tk/xlate",type:"POST",contentType:"application/x-www-form-urlencoded; charset=UTF-8",data:{src:$("#txtInput").val()}});$(".nmtHeader .button").addClass("disabled"),$(".nmtHeader i").addClass("visible"),s(),e.done(function(e){if($(".nmtHeader .button").removeClass("disabled"),$(".nmtHeader i").removeClass("visible"),"ok"==e.status){$("#xlStraight").text(e.real.tgt),$("#xlStraight").removeClass("meta");var t=e.real_sec.toFixed(2)+"s; "+e.real.pred_score.toFixed(2);$("#xlStraight").append("<div class='xlstats'>"+t+"</div>"),$("#xlCrazy").text(e.crazy.tgt),$("#xlCrazy").removeClass("meta"),t=e.crazy_sec.toFixed(2)+"s; "+e.crazy.pred_score.toFixed(2),$("#xlCrazy").append("<div class='xlstats'>"+t+"</div>")}else s("** The server is overloaded. Please try again in a bit. **")}),e.fail(function(e,t,a){$(".nmtHeader .button").removeClass("disabled"),$(".nmtHeader i").removeClass("visible"),s("** Sorry; the service seems to be unavailable right now. **")})}})})}();